...
#   python $WORKSPACE/frame_latency_meter/build/jenkins/update_version.py <major> <minor> <build-number>
#
import os
import argparse
...
cmpVersionFile = os.path.join(os.environ['WORKSPACE'], 'frame_latency_meter/source/flm_backend/version.h')
